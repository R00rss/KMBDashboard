...
function Reportes2() {
    ...
    if (date_to_number(date) !== -1) {
      if (client === null) {
        if (selectedCooperativa !== "")
          consultarDetalles(date_to_number(date), selectedCooperativa);
  ...
  useEffect(() => {
    ...
    if (date_to_number(date) !== -1) {
      if (client === null) {
        if (selectedCooperativa !== "")
          consultarReportes(date_to_number(date), selectedCooperativa);
      ...
      {validate === "true" ? (
        <>
          ...
          {tab1 ? (
            <>
              <HomeReportes2
                callbackFunction={getDateFromHomeReportes}
                client={client}
              />
              <>
